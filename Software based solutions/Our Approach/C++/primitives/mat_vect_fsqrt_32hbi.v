...
+ Module    : Floating point square_root GENERATED BY FLOPOCO [name: mat_vect_fsqrt_32hbi]
+ Abstract  : The implementation of a floating point square_root using a pipelined circuit of LATENCY: 11
+ Notes     : 
  ...
  - The <NUM_STAGE> parameter has no effect on the module specification. For documentation purposes it indicates this instance
    of the square_root is not pipelined
*/
// File results//mat_vect_fsqrt_32hbi.vhdl translated with vhd2vl v3.0 VHDL to Verilog RTL translator
// vhd2vl settings:
...
wire [22:0] fracX;
wire [7:0] eRn0;
wire [2:0] xsX; reg [2:0] xsX_d1; reg [2:0] xsX_d2; reg [2:0] xsX_d3; reg [2:0] xsX_d4; reg [2:0] xsX_d5; reg [2:0] xsX_d6; reg [2:0] xsX_d7; reg [2:0] xsX_d8; reg [2:0] xsX_d9; reg [2:0] xsX_d10; reg [2:0] xsX_d11;
wire [7:0] eRn1; reg [7:0] eRn1_d1; reg [7:0] eRn1_d2; reg [7:0] eRn1_d3; reg [7:0] eRn1_d4; reg [7:0] eRn1_d5; reg [7:0] eRn1_d6; reg [7:0] eRn1_d7; reg [7:0] eRn1_d8; reg [7:0] eRn1_d9; reg [7:0] eRn1_d10; reg [7:0] eRn1_d11;
wire [26:0] w26;
wire d25;
wire [27:0] x25;
wire [3:0] ds25;
...
wire [6:0] xh22;
reg [6:0] wh22;
wire [26:0] w22; reg [26:0] w22_d1;
wire [3:0] s22; reg [3:0] s22_d1;
wire d21;
wire [27:0] x21;
wire [7:0] ds21;
wire [7:0] xh21;
...
wire [9:0] xh19;
reg [9:0] wh19;
wire [26:0] w19; reg [26:0] w19_d1;
wire [6:0] s19; reg [6:0] s19_d1;
wire d18;
wire [27:0] x18;
wire [10:0] ds18;
wire [10:0] xh18;
...
wire [12:0] xh16;
reg [12:0] wh16;
wire [26:0] w16; reg [26:0] w16_d1;
wire [9:0] s16; reg [9:0] s16_d1;
wire d15;
wire [27:0] x15;
wire [13:0] ds15;
wire [13:0] xh15;
...
wire [14:0] xh14;
reg [14:0] wh14;
wire [26:0] w14; reg [26:0] w14_d1;
wire [11:0] s14; reg [11:0] s14_d1;
wire d13;
wire [27:0] x13;
wire [15:0] ds13;
wire [15:0] xh13;
...
wire [16:0] xh12;
reg [16:0] wh12;
wire [26:0] w12; reg [26:0] w12_d1;
wire [13:0] s12; reg [13:0] s12_d1;
wire d11;
wire [27:0] x11;
wire [17:0] ds11;
wire [17:0] xh11;
...
wire [18:0] xh10;
reg [18:0] wh10;
wire [26:0] w10; reg [26:0] w10_d1;
wire [15:0] s10; reg [15:0] s10_d1;
wire d9;
wire [27:0] x9;
wire [19:0] ds9;
wire [19:0] xh9;
...
wire [20:0] xh8;
reg [20:0] wh8;
wire [26:0] w8; reg [26:0] w8_d1;
wire [17:0] s8; reg [17:0] s8_d1;
wire d7;
wire [27:0] x7;
wire [21:0] ds7;
wire [21:0] xh7;
...
wire [22:0] xh6;
reg [22:0] wh6;
wire [26:0] w6; reg [26:0] w6_d1;
wire [19:0] s6; reg [19:0] s6_d1;
wire d5;
wire [27:0] x5;
wire [23:0] ds5;
wire [23:0] xh5;
...
wire [24:0] xh4;
reg [24:0] wh4;
wire [26:0] w4; reg [26:0] w4_d1;
wire [21:0] s4; reg [21:0] s4_d1;
wire d3;
wire [27:0] x3;
wire [25:0] ds3;
wire [25:0] xh3;
...
wire [26:0] xh2;
reg [26:0] wh2;
wire [26:0] w2; reg [26:0] w2_d1;
wire [23:0] s2; reg [23:0] s2_d1;
wire d1;
wire [27:0] x1;
wire [27:0] ds1;
wire [27:0] xh1;
...
wire d0;
wire [26:0] fR;
reg [24:0] fRn1; reg [24:0] fRn1_d1;
...
reg [2:0] xsR;
  ...
  assign x21 = {w22_d1,1'b0};
  assign ds21 = {1'b0,s22_d1, ~d21,d21,1'b1};
  ...
  assign x18 = {w19_d1,1'b0};
  assign ds18 = {1'b0,s19_d1, ~d18,d18,1'b1};
  ...
  assign x15 = {w16_d1,1'b0};
  assign ds15 = {1'b0,s16_d1, ~d15,d15,1'b1};
  ...
  assign x13 = {w14_d1,1'b0};
  assign ds13 = {1'b0,s14_d1, ~d13,d13,1'b1};
  ...
  assign x11 = {w12_d1,1'b0};
  assign ds11 = {1'b0,s12_d1, ~d11,d11,1'b1};
  ...
  // Step 9
  assign d9 = w10_d1[26];
  assign x9 = {w10_d1,1'b0};
  assign ds9 = {1'b0,s10_d1, ~d9,d9,1'b1};
  assign xh9 = x9[27:8];
  always @(*) begin
    case(d9)
      1'b0 : wh9 <= xh9 - ds9;
  ...
  // Step 7
  assign d7 = w8_d1[26];
  assign x7 = {w8_d1,1'b0};
  assign ds7 = {1'b0,s8_d1, ~d7,d7,1'b1};
  assign xh7 = x7[27:6];
  always @(*) begin
    case(d7)
      1'b0 : wh7 <= xh7 - ds7;
  ...
  // Step 5
  assign d5 = w6_d1[26];
  assign x5 = {w6_d1,1'b0};
  assign ds5 = {1'b0,s6_d1, ~d5,d5,1'b1};
  assign xh5 = x5[27:4];
  always @(*) begin
    case(d5)
      1'b0 : wh5 <= xh5 - ds5;
  ...
  // Step 3
  assign d3 = w4_d1[26];
  assign x3 = {w4_d1,1'b0};
  assign ds3 = {1'b0,s4_d1, ~d3,d3,1'b1};
  assign xh3 = x3[27:2];
  always @(*) begin
    case(d3)
      1'b0 : wh3 <= xh3 - ds3;
  ...
  // Step 1
  assign d1 = w2_d1[26];
  assign x1 = {w2_d1,1'b0};
  assign ds1 = {1'b0,s2_d1, ~d1,d1,1'b1};
  assign xh1 = x1[27:0];
  always @(*) begin
    case(d1)
      1'b0 : wh1 <= xh1 - ds1;
  ...
  assign fRn2 = fRn1_d1[24:2] + ({22'b0000000000000000000000,round_d1});
  // rounding sqrt never changes exponents 
  assign Rn2 = {eRn1_d11,fRn2};
